...
from Model.ablation import Backbone_Baseline, Backbone_MRE, Backbone_ACF, Backbone_SAEB, Backbone_MRE_ACF
# Local imports
from Options.Options_x_PICAI import Options_x_PICAI_Backbone_MRE_ACF, Options_x_PICAI_Backbone_SAEB, Options_x_PICAI_Backbone_ACF, Options_x_PICAI_Backbone_MRE, Options_x_PICAI_Backbone
...
def main():
    # Parse options
    opt_parser = Options_x_PICAI_Backbone_SAEB()
