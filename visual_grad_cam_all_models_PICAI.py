...
OUTPUT_FILENAME = f"PICAI-{CASE_ID}_slice{SLICE_INDEX:02d}_gradcam.png"
SHOW_TITLES = False
...
MODELS_CFG = [
    {
        "name": "Baseline",
        "checkpoint": "checkpoints/SegTumor_DIY_PICAI_Backbone/best_dice_model.pth",
        "model_type": "Backbone_Baseline",
        "target_layer": "decoder1",
    },
    {
        "name": "Backbone_MRE",
        "checkpoint": "checkpoints/SegTumor_DIY_PICAI_Backbone_MRE/best_dice_model.pth",
        "model_type": "Backbone_MRE",
        "target_layer": "decoder1",
    },
    {
        "name": "Backbone_ACF",
        "checkpoint": "checkpoints/SegTumor_DIY_PICAI_Backbone_ACF/best_dice_model.pth",
        "model_type": "Backbone_ACF",
        "target_layer": "decoder1",
    },
    {
        "name": "Backbone_SAEB",
        "checkpoint": "checkpoints/SegTumor_DIY_PICAI_Backbone_SAEB/best_dice_model.pth",
        "model_type": "Backbone_SAEB",
        "target_layer": "decoder1",
    },
    {
        "name": "Backbone_MRE_ACF",
        "checkpoint": "checkpoints/SegTumor_DIY_PICAI_Backbone_MRE_ACF/best_dice_model.pth",
