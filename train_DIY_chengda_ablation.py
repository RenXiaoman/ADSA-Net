...
# Local imports
from Options.Options_x import Options_x_chengda_Backbone_MRE_ACF
from dataset.dataset_nnunet import Lits_DataSet
# from utils.nnunet_augmentation import nnunet_style_augmentation


def poly_lr(epoch, max_epochs, initial_lr, exponent=0.99):
    """
...
def main():
    # Parse options
    opt_parser = Options_x_chengda_Backbone_MRE_ACF()
